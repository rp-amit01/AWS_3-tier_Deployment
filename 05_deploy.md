# **_3-teir deployment with - AWS EC2 + Load Balancer + AutoScaling + Cloud Watch + SNS & Event Bridge**


Here we are deploying a 3-teir project with the help of AWS services like EC2 , Load Balancer , AutoScaling , Cloud Watch , SNS & Event Bridge. 
